...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-8 bg-gradient-to-br from-purple-900/20 to-pink-900/20">
      <div className="w-full max-w-md">
        {/* Logo */}
        <div className="text-center mb-8">
          <div className="flex items-center justify-center space-x-2 mb-4">
            <div className="relative">
              <Film className="h-10 w-10 text-neon-purple" />
              <Heart className="h-5 w-5 text-neon-red absolute -top-1 -right-1 animate-pulse" />
            </div>
            <span className="text-2xl font-bold text-neon">Cinecrush</span>
          </div>
          <p className="text-muted-foreground">Join the cinema dating revolution!</p>
        </div>

        <Card className="card-movie border-neon">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Create Account</CardTitle>
            <CardDescription>
              Start your journey to find love through movies
            </CardDescription>
          </CardHeader>
          <CardContent>
